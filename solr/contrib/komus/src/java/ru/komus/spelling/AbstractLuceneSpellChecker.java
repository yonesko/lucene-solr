...
public abstract class AbstractLuceneSpellChecker extends SolrSpellChecker {
    public static final Logger log = LoggerFactory.getLogger(org.apache.solr.spelling.AbstractLuceneSpellChecker.class);
    ...
    * */
    ...
    public SpellingResult getSuggestions(SpellingOptions options) throws IOException {
        ...
        int count = Math.max(options.count, org.apache.solr.spelling.AbstractLuceneSpellChecker.DEFAULT_SUGGESTION_COUNT);
